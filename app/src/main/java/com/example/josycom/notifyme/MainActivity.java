...
public class MainActivity extends AppCompatActivity {
    private static final String ACTION_UPDATE_NOTIFICATION = "com.example.josycom.notifyme.ACTION_UPDATE_NOTIFICATION";
    ...
    private NotificationCompat.Builder getNotificationBuilder(){
        ...
        PendingIntent clearPendingIntent = PendingIntent.getBroadcast(this, NOTIFICATION_ID, clearIntent, PendingIntent.FLAG_ONE_SHOT);
     ...
     public void updateNotification() {
        ...
        notifyBuilder.setStyle(new NotificationCompat.InboxStyle()
                .addLine("This is a test line")
                .addLine("This is another test line")
                .addLine("This is yet another test line")
                .setBigContentTitle("Testing a test Line")
                .setSummaryText("Test line"));
